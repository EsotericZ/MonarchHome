...
import { Alert, Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, Icon, IconButton, Paper, Snackbar, Tab, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tabs, TextField, Typography } from '@mui/material';
                        ...
                        .map((job, index) => {
                          return (
                            <TableRow key={index} sx={{ backgroundColor: index % 2 === 0 ? '#f0f0f0' : '#fff' }}>
                              ...
                              <TableCell align='center' sx={{ fontSize: '15px', p: 1.25 }}>
                                <CopyToClipboard text={job.SubPartNo} onCopy={() => { setShowToast(true); setPartCopy(`${job.SubPartNo}`); }}>
                                  <span>{job.SubPartNo}</span>
                                </CopyToClipboard>
                              </TableCell>
                            </TableRow>
                          )
